...
props: {
    ...
    mounted() {
            ...
            this.form.sec_prottoyon = `স্থানীয় সরকার (পৌরসভা) আইন, ২০০৯ ইং এর সংশ্লিষ্ট ধারা ও উপধারা অনুসারে (ট্রেড, প্রফেশন, কলিং ও বিজ্ঞাপন) ব্যবসা/পেশার  অনুমোদন পত্র উপরে বর্ণিত ব্যক্তি/প্রতিষ্ঠানের অনুকূলে দেওয়া হইল। যাহার মেয়াদ ${this.dateformatGlobal()[10]} ইং সনের 30 জুন পর্যন্ত কার্যকর থাকিবে।
<br/>
<br/>
